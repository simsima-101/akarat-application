  ...
  Future<void> _fetchMore() async {
    ...
    try {
      ...
      setState(() {
        ...
        _hasMore = (metaJson['current_page'] ?? _page) <
            (metaJson['last_page'] ?? _page);
        _isFetchingMore = false;
      });

      debugPrint(
          '📦 Appended ${newItems.length}, total=${filterModel.data!.length}, hasMore=$_hasMore');
    } catch (e) {
...
// buildApiUrl() already strips this to '' for the query param.
  ...
  int? selectedIndex;
  String ftype = ' ';
  final List _ftype = ['All', 'Furnished', 'Semi furnished', 'Unfurnished'];
  final List _bedroom = [
    'studio',
    '1',
    '2',
  ...
  int? selectedbedroom;
  String bedroom = ' ';
  final List _bathroom = ['1', '2', '3', '4', '5', '6+'];
  int? selectedbathroom;
  final List _product = ['Rent', 'Buy', 'New Projects', 'Commercial'];
  final List _rent = [
    'Yearly',
    'Monthly',
    'Daily',
  ...
  Future<void> propertyApi(String purpose, {String? location}) async {
    ...
    // 🌐 Build the URI using ApiService (no queryParameters param)
    late final Uri uri;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint(
          "❌ Property API failed [${response.statusCode}]: ${response.reasonPhrase}",
        );
      }
    } catch (e) {
  ...
  Future<void> showResult() async {
    ...
    try {
      ...
      if (res.statusCode != 200) {
        ...
        setState(() {
          filterModel = fm.FilterModel(data: []);
          _isLoading = false;
          _hasMore = false;
        });
        return;
...
// adjust to your item model type
      ...
      setState(() {
        ...
        _hasMore =
            (metaJson['current_page'] ?? 1) < (metaJson['last_page'] ?? 1);
        _isLoading = false;
      });
  ...
  Future<void> fetchLocations() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          locationList =
              jsonData.map<String>((item) => item['name'].toString()).toList();
        });
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Material(
                                ...
                                clipBehavior: Clip
                                    .hardEdge, // ✅ Needed for proper tap area
                                child: InkWell(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                                                  ...
                                                  return GestureDetector(
                                                    onTap: () async {
                                                      setModalState(() {
                                                        ...
                                                        print(
                                                            'Selected bedroom for API: $bedroom');
                                                      });
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              padding: const EdgeInsets.symmetric(
                                  vertical: 8,
                                  horizontal: 8), // gives natural height
                              decoration: BoxDecoration(
                                shape: BoxShape.rectangle,
                                border: Border.all(width: 1),
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(
                                top: 3, bottom: 3, right: 10, left: 0),
                            child: Container(
                              width: 70,
                              padding: const EdgeInsets.symmetric(
