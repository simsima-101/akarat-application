...
// //           query: {
// //             'location':
// //                 encodedLocation, // or just `location` if it's not pre-encoded
// //           },
// //         ),
// //       );
// //
...
// //
// //         // Check if the API returned empty or null data
// //         if (jsonData == null ||
// //             jsonData['data'] == null ||
...
// //             isError = true;
// //           });
// //           debugPrint("❌ No results found for $location");
// //           return;
// //         }
// //
...
// //       if (property_type.trim().isNotEmpty)
// //         params['property_type'] = property_type.trim();
...
// //               selectedPropertyType: (property_type.trim().isEmpty ||
...
// //                   top: 40, left: 10), // Add top padding for status bar
// //               child: Align(
...
// //                     width: 20, // usually 24-32 is better for touch targets
// //                     height: 20,
// //                     fit: BoxFit.contain,
// //                   ),
// //                 ),
// //               ),
// //             ),
// //             // ... the rest of your widgets, e.g. Expanded(child: Center(...))
// //             Expanded(
// //               child: Center(
// //                 child: Column(
// //                   mainAxisAlignment: MainAxisAlignment.center,
// //                   children: [
// //                     Icon(Icons.search_off, size: 60, color: Colors.red),
// //                     SizedBox(height: 10),
// //                     Text(
...
// //                                         scrollDirection: Axis.horizontal,
// //                                         itemCount:
// //                                             propertyTypeModel?.data?.length ??
// //                                                 0,
// //                                         itemBuilder: (context, index) {
// //                                           final item =
// //                                               propertyTypeModel!.data![index];
// //                                           final isSelected =
// //                                               selectedtype == index;
// //
// //                                           return GestureDetector(
...
// //                     child: Padding(
// //                       padding:
// //                           const EdgeInsets.only(top: 3, bottom: 3, right: 10),
// //                       child: Container(
// //                         width: 90,
// //                         height: 10,
...
// //           Padding(
// //               padding:
// //                   const EdgeInsets.only(top: 5, left: 15, right: 0, bottom: 15),
// //               child: Container(
// //                 alignment: Alignment.topLeft,
// //                 height: 50,
// //                 child: ListView.builder(
...
// //             itemBuilder: (context, index) {
// //               bool isFavorited =
// //                   favoriteProperties.contains(searchModel!.data![index].id);
...
// //                     child: Padding(
// //                       padding:
// //                           const EdgeInsets.only(left: 5.0, top: 0, right: 5),
// //                       child: Column(
...
// //                                 child: Text(
// //                                   searchModel!.data![index].title.toString(),
...
// //                               Padding(
// //                                 padding: const EdgeInsets.only(
// //                                     left: 15, right: 5, top: 0, bottom: 10),
// //                                 child: Image.asset(
...
// //                                 child: Text(
// //                                   searchModel!.data![index].location.toString(),
// //                                   style: TextStyle(
// //                                       fontSize: 13,
// //                                       height: 1.4,
...
// //                                   child: Text(
// //                                     searchModel!.data![index].bedrooms
// //                                         .toString(),
// //                                     style:
...
// //                                       left: 5, right: 5, top: 5),
// //                                   child: Text(
// //                                     searchModel!.data![index].bathrooms
// //                                         .toString(),
// //                                     style:
// //                                         TextStyle(fontWeight: FontWeight.bold),
// //                                   )),
...
// //                                       left: 5, right: 5, top: 5),
// //                                   child: Text(
// //                                     searchModel!.data![index].squareFeet
// //                                         .toString(),
// //                                     style:
// //                                         TextStyle(fontWeight: FontWeight.bold),
// //                                   )),
...
// //                                   onPressed: () async {
// //                                     String phone =
// //                                         'tel:${searchModel!.data![index].phone}';
// //                                     try {
// //                                       final bool launched =
...
// //                                   onPressed: () async {
// //                                     final phone =
// //                                         searchModel!.data![index].whatsapp;
// //                                     final url = Uri.parse(
...
//   Data(this.x, this.y);
// }
// >>>>>>> bc91993 (Resolve merge conflicts)
