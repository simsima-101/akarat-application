...
class SecureStorage {
  ...
  // ========================================
  // LOGIN METHOD (Email vs Google)
  // ========================================
  static Future<void> setLoginMethod(String method) async {  // ← Correct name: setLoginMethod
    await _storage.write(key: 'login_method', value: method.trim());
  }

  static Future<String?> getLoginMethod() async {  // ← Correct name
    return await _storage.read(key: 'login_method');
  }

  static Future<void> deleteLoginMethod() async {
