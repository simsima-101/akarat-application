                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          l10n.agentPropertiesCount((agentsModel.propertiesCount ?? 0).toString()),  // ← positional
                          style: const TextStyle(
                            fontSize: 12,
                        ...
                        const SizedBox(height: 4),
                        Text(
                          '${l10n.agentSpeaksLabel}${agentsModel.languages?.trim().isNotEmpty == true ? agentsModel.languages : l10n.notAvailable}',
                        ...
                        Row(
                          children: [
                            if (agentsModel.sale != null && agentsModel.sale! > 0)
                              _buildTag(
                                l10n.agentSaleTag(agentsModel.sale!.toString()),   // ← positional
                              ),
                            const SizedBox(width: 10),
                            if (agentsModel.rent != null && agentsModel.rent! > 0)
                              _buildTag(
                                l10n.agentRentTag(agentsModel.rent!.toString()),   // ← positional
                              ),
                          ],
                        ),
